...
class WeightTrackersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weight_tracker" do
    assert_difference("WeightTracker.count") do
      post weight_trackers_url, params: { weight_tracker: { exercise: @weight_tracker.exercise, reps: @weight_tracker.reps, weight: @weight_tracker.weight } }
    end
  ...
  test "should update weight_tracker" do
    patch weight_tracker_url(@weight_tracker), params: { weight_tracker: { exercise: @weight_tracker.exercise, reps: @weight_tracker.reps, weight: @weight_tracker.weight } }
